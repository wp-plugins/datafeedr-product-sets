...
class Dfrps_Update {
	...
	function updates_disabled_email_user( $obj ) {
		...
		$params['message']  = __( "This is an automated message sent from: ", DFRPS_DOMAIN ) . get_bloginfo( 'wpurl' ) . "\n\n";
		$params['message'] .= __( "An error occurred during the update of Product Set: ", DFRPS_DOMAIN ) . $this->set['post_title'] . __( " (ID: ", DFRPS_DOMAIN ) . $this->set['ID'] . ")\n\n";
		$params['message'] .= __( "Error details:", DFRPS_DOMAIN ) . "\n";
		$params['message'] .= "#################################################\n";
		$params['message'] .= __( "CLASS: ", DFRPS_DOMAIN ) . $obj['dfrapi_api_error']['class'] . "\n";
		$params['message'] .= __( "CODE: ", DFRPS_DOMAIN ) . $obj['dfrapi_api_error']['code'] . "\n";
		$params['message'] .= __( "MESSAGE: ", DFRPS_DOMAIN ) . $obj['dfrapi_api_error']['msg'] . "\n";
		...
		$params['message'] .= "#################################################\n\n";
		$params['message'] .= __( "All updates have been disabled.", DFRPS_DOMAIN ) . "\n\n";
		$params['message'] .= __( "Please fix the error and then enable updates again.", DFRPS_DOMAIN ) . "\n\n";
		$params['message'] .= __( "Edit Product Set: ", DFRPS_DOMAIN ) . add_query_arg( array( 'post' => $this->set['ID'], 'action' => 'edit' ), admin_url( 'post.php') ) . "\n";
		$params['message'] .= __( "Enable Updates: ", DFRPS_DOMAIN ) . admin_url( 'admin.php?page=dfrps_configuration' ) . "\n";
		$params['message'] .= __( "View Account: ", DFRPS_DOMAIN ) . admin_url( 'admin.php?page=dfrapi_account' ) . "\n";				
		$params['message'] .= __( "Upgrade Account: ", DFRPS_DOMAIN ) . dfrapi_user_pages( 'change' );
